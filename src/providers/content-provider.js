...
import { MAX_ENVELOPE_BYTES, parseEnvelopeText, safeEnvelopeMeta, validateEnvelopeShape } from '../content-pack.js';

export const CONTENT_DELIVERY_SCHEMA = 'maturita-desk-content-delivery-v1';

export function createLocalEncryptedContentProvider(store) {
  ...
  return Object.freeze({
    ...
    async loadEnvelope() { return store.loadActiveEnvelope(); },
...
export function createLockedContentProvider(reason = 'Runtime konfigurace je uzamčená.') {
  ...
  return Object.freeze({
    kind: 'locked', remote: false, allowManualImport: false,
