...
with sync_playwright() as pw:
    ...
    page.evaluate("""async () => { const c=await caches.open('ghrab-maturita-desk-v1.0.4'); await c.put('./synthetic-static', new Response('synthetic static cache')); }""")
    caches_before = page.evaluate("caches.keys()")
    assert 'ghrab-maturita-desk-v1.0.4' in caches_before, caches_before
